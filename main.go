...
var (
	...
	*/
	BuildVersion   = "v1.51.1"
	BuildDate      = "2023-08-07-10:21:38"
	BuildCommitSha = "c3efa55016c226a43a66b0a8b44cdb0c149048c4"
)
...
func main() {
	var (
		sentinelAddr         = flag.String("sentinel.addr", getEnv("SENTINEL_ADDR", ""), "Redis Sentinel host:port.")
	...
	log.Printf("My Redis Exporter %s    build date: %s    sha1: %s    Go: %s    GOOS: %s    GOARCH: %s",
